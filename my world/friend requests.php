...
<td style="width: 220px" class="style1"><a href="http://en.wikipedia.org/wiki/<?php echo $row[10]?>" target="_blank" title="Click here to know greatness of <?php echo $row[10]?>"><?php echo $row[10]?></a></td>
<td style="width: 169px" class="style2">
<form method="post">
	<input id="sndreq" type="button" value="Accept Request" style="width: 109px; height: 32px"></form>
</td>
<?php 
}
?>
